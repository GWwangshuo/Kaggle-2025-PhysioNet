...
class ECGScanDataset(torch.utils.data.Dataset[Any]):
    def __init__(self, data_path: str, transform: Any = None, mode: str = 'train') -> None:
    ...
    def read_truth_series(self, sample_id):
        ...
        truth_df = pd.read_csv(f"{self.data_path}/train/{image_id}/{image_id}.csv")
    ...
    def __getitem__(self, idx: int) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        scan_path = f'{self.data_path}/recified_images/{scan_id}.png'
...
if __name__ == '__main__':
    from util.transforms import build_transforms
